    ...
    <body>
        <div class="row"><!--row start-->
            <div class="col-lg-12"><!--col-lg-12 start-->
                <h1 class="page-header" style="color: #155567;">Edit Product Category</h1>

                <ol class="breadcrumb">
                    <li class="active">
                        <i class="fa fa-list-alt"> Products Categories / Edit Product Category</i>
                    </li>
                </ol>            
                    ...
                    <div class="panel-heading"><!--panel-heading start-->
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                    <label for="" class="col-md-3 control-label">Product Category ID</label>
                                    <div class="col-md-6">
...
if(isset($_POST['update'])){
    ...
    $update_p_cat= "update product_categories set p_cat_title='$product_c_title',p_cat_desc='$product_c_desc' where p_cat_id='$p_cat_id'";
